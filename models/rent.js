...
const findRentalByCustomerAndItem = async (itemId, customerId) => {
    const sqlQuery = `SELECT * FROM rents where itemId =:itemId AND customerId=:customerId;`;
...
module.exports = {
    Rental, findRentalById, findAllRentalItemIn, updateEndDate, rentAdd, checkAvailableRent, rentDelete, rentList,
    statusRentList, updateRentStatus, updateLateDay, getRentRecordsForMonth, findRentalByCustomerAndItem
};
